      ...
      <div className="w-full max-w-sm mx-auto bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
        ...
        <div className="mt-4">
          <button
            ...
            className="w-full flex flex-wrap gap-1 items-center justify-center bg-[#0D0842] hover:bg-blue-900 text-white font-bold py-2 px-4 rounded focus:outline-none"
          >
